...
OFILES = main.o mylib.o text.o mydma.o background.o player_car.o civilian_car1.o civilian_car2.o spy_car1.o spy_car2.o car_gun.o explosion.o title_screen.o game_over.o

# The header files you have created.
# This is necessary to determine when to recompile for files.
# This should be a space (SPACE!) separated list of .h files
HFILES = mylib.h text.h mydma.h fixedmath.h background.h player_car.h civilian_car1.h civilian_car2.h spy_car1.h spy_car2.h car_gun.h explosion.h title_screen.h game_over.h
